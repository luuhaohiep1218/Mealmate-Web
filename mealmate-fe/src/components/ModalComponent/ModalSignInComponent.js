...
import { Modal, Form, Input, Button, Divider, message, Alert } from "antd";
...
const ModalSignInComponent = ({ isOpen, onClose }) => {
  ...
  const { login, register, handleGoogleLogin } = useMealMate();
  ...
  const handleForgotPassword = async () => {
    try {
      ...
      if (!email) {
        return message.error("Vui lòng nhập email của bạn");
      }
    ...
    <Modal
      ...
      title={
        <ModalHeader>
          ...
          <SubTitle>
            {isSignUp
              ? "Tạo tài khoản mới tại Mealmate!"
              : "Chào mừng bạn trở lại với Mealmate!"}
          </SubTitle>
        </ModalHeader>
      }
    >
